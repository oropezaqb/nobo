            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <?php $authorized = \DB::table('users')->leftJoin('roles', 'users.role_id', '=', 'roles.id')
                        ...
                        ->where('permissions.key', 'read_payments')->exists(); ?>
                    @if ($authorized)
                        @if (session('status'))
                        ...
                        <form method="POST" action="/payments">
                            ...
                            <div class="form-group custom-control-inline">
                                ...
                                <input type="date" class="form-control @error('period_start') is-danger @enderror" id="period_start" name="period_start"
                                    value="{!! old('period_start', $payment->voucher->bill->period_start) !!}" disabled>
                            </div>
                            <div class="form-group custom-control-inline">
                                ...
                                <input type="date" class="form-control @error('period_end') is-danger @enderror" id="period_end" name="period_end"
                                    value="{!! old('period_end', $payment->voucher->bill->period_end) !!}" disabled>
                            </div>
                            <div class="form-group">
                                <label for="particulars">Particulars </label>
                                <textarea class="form-control" rows="5" id="particulars" name="particulars" disabled>{{ old('particulars', $payment->voucher->bill->particulars) }}</textarea>
                            </div>
                            <br>
                            <div class="form-group custom-control-inline">
                                <label for="amount">Amount</label>&nbsp;
                                <input type="number" class="form-control amount" id="amount" name="amount" step="0.01" style="text-align: right;"
                                    value="{!! old('amount', $payment->voucher->bill->amount) !!}" disabled>
                            </div>
                            <br><br>
                            <div class="form-group custom-control-inline">
                                <label for="date">Document date:&nbsp;</label>&nbsp;
                                <input type="date" class="form-control @error('date') is-danger @enderror" id="date" name="date" value="{!! old('date', $payment->voucher->date) !!}" disabled>
                            </div>
                            <div class="form-group custom-control-inline">
                                <label for="posted_at">Posting date:&nbsp;</label>&nbsp;
                                <input type="date" class="form-control @error('posted_at') is-danger @enderror" id="posted_at" name="posted_at" value="{!! old('posted_at', $payment->voucher->posted_at) !!}" disabled>
                            </div>
                            <div class="form-group custom-control-inline">
                                ...
                                <input type="number" class="form-control amount" id="payable_amount" name="payable_amount" step="0.01" style="text-align: right;"
                                    value="{!! old('payable_amount', $payment->voucher->payable_amount) !!}" disabled>
                            </div>
                            <div class="form-group">
                                <label for="remarks">Remarks </label>
                                <textarea class="form-control" rows="5" id="remarks" name="remarks" disabled>{{ old('remarks', $payment->remarks) }}</textarea>
                            </div>
                            <br>
                            <div class="form-group custom-control-inline">
                                ...
                                <input type="text" class="form-control" id="check_number" name="check_number" style="text-align: right;"
                                    value="{!! old('check_number', $payment->check_number) !!}" disabled>
                            </div>
                            <div class="form-group custom-control-inline">
                                <label for="check_date">Check&nbsp;date:&nbsp;</label>&nbsp;
                                <input type="date" class="form-control @error('check_date') is-danger @enderror" id="check_date" name="check_date" value="{!! old('check_date', $payment->check_date) !!}" disabled>
                            </div>
                            <div class="form-group custom-control-inline">
                                ...
                                <input type="text" class="form-control" id="cancelled_checks" name="cancelled_checks" style="text-align: left;"
                                    value="{!! old('cancelled_checks', $payment->cancelled_checks) !!}" disabled>
                            </div>
                            <br><br>
                            <div class="form-group custom-control-inline">
                                <label for="paid_at">Date&nbsp;paid:&nbsp;</label>&nbsp;
                                <input type="date" class="form-control @error('paid_at') is-danger @enderror" id="paid_at" name="paid_at" value="{!! old('paid_at', $payment->paid_at) !!}" disabled>
                            </div>
                            <br><br>
                            <div class="form-group custom-control-inline">
                            ...
                            <div class="form-group custom-control-inline">
                                ...
                                <input type="number" class="form-control amount" id="cleared_amount" name="cleared_amount" step="0.01" style="text-align: right;"
                                    value="{!! old('cleared_amount', $payment->cleared_amount) !!}" disabled>
                            </div>
                            <div class="form-group custom-control-inline">
                                ...
                                <input type="number" class="form-control amount" id="service_charge" name="service_charge" step="0.01" style="text-align: right;"
                                    value="{!! old('service_charge', $payment->service_charge) !!}" disabled>
                            </div>
                            ...
                            <div class="form-group custom-control-inline">
                                ...
                                <input type="text" class="form-control" id="receipt_number" name="receipt_number" style="text-align: right;"
                                    value="{!! old('receipt_number', $payment->receipt_number) !!}" disabled>
                            </div>
                            <div class="form-group custom-control-inline">
                                <label for="receipt_received_at">Receipt&nbsp;received&nbsp;at</label>&nbsp;
                                <input type="date" class="form-control @error('receipt_received_at') is-danger @enderror" id="receipt_received_at" name="receipt_received_at" value="{!! old('receipt_received_at', $payment->receipt_received_at) !!}" disabled>
                            </div>
                            <br><br>
                        </form>
                        <div style="clear: both;">
                            <div style="display: inline-block;">
                                <button class="btn btn-outline-primary" onclick="location.href = '/payments/{{ $payment->id }}/edit';">Edit</button>
                            </div>
                            <div style="display: inline-block;">
