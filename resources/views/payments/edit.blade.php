            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <?php $authorized = \DB::table('users')->leftJoin('roles', 'users.role_id', '=', 'roles.id')
                        ...
                        ->where('permissions.key', 'edit_payments')->exists(); ?>
                    @if ($authorized)
                        @if (session('status'))
                        ...
                        <form method="POST" action="/payments/{{ $payment->id }}">
                            ...
                            <div class="form-group custom-control-inline">
                                ...
                                <input type="number" id="voucher_number" name="voucher_number" style="text-align: right;" data-id="" class="form-control"
                                    value="{!! old('voucher_number', $payment->voucher->number) !!}" oninput="getVoucher()">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" id="remarks" name="remarks">{{ old('remarks', $payment->remarks) }}</textarea>
                            </div>
                            <br>
                            <div class="form-group custom-control-inline">
