            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <?php $authorized = \DB::table('users')->leftJoin('roles', 'users.role_id', '=', 'roles.id')
                        ...
                        ->where('permissions.key', 'edit_bank_endorsements')->exists(); ?>
                    @if ($authorized)
                        @if (session('status'))
                        ...
                        <form method="POST" action="/bank-endorsements/{{ $bankEndorsement->id }}">
                            ...
                            <div class="form-group custom-control-inline">
                                ...
                                <input type="number" id="voucher_number" name="voucher_number" style="text-align: right;" data-id="" class="form-control"
                                    value="{!! old('voucher_number', $bankEndorsement->voucher->number) !!}" oninput="getVoucher()">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" id="remarks" name="remarks">{{ old('remarks', $bankEndorsement->remarks) }}</textarea>
                            </div>
                            <br>
                            <div class="form-group custom-control-inline">
                                <label for="approved_at">Date approved:&nbsp;</label>&nbsp;
                                <input type="date" class="form-control @error('approved_at') is-danger @enderror" id="approved_at" name="approved_at" value="{!! old('approved_at', $bankEndorsement->approved_at) !!}">
                            </div>
                            <div class="form-group custom-control-inline">
                    ...
                    @else
                        You are not authorized to edit bank endorsements.
                    @endif
                </div>
            </div>
        </div>
