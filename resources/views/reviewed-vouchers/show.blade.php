                    ...
                    @if ($authorized)
                        ...
                        <form method="POST" action="/reviewed-vouchers">
                            ...
                            <div class="form-group custom-control-inline">
                                ...
                                <input type="date" class="form-control @error('endorsed_at') is-danger @enderror" id="endorsed_at" name="endorsed_at" value="{!! old('endorsed_at', $reviewedVoucher->voucher->endorsed_at) !!}" disabled>
                            </div>
