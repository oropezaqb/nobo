            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <?php $authorized = \DB::table('users')->leftJoin('roles', 'users.role_id', '=', 'roles.id')
                        ...
                        ->where('permissions.key', 'edit_queries')->exists(); ?>
                    @if ($authorized)
                        <form method="POST" action="/queries/{{ $query->id }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title" style="text-align: left;"
                                    required value="{!! old('title', $query->title) !!}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group custom-control-inline">
                                ...
                                <input list="permission_ids" id="permission_id0" onchange="setValue(this)" data-id="" class="custom-select" required value="{!! old('permission_name', $query->permission->key) !!}">
                    ...
                    @else
                        You are not authorized to edit queries.
                    @endif
